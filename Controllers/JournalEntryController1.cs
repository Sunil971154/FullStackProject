...
namespace Revision_Project.Controllers
{
    ...
    public class JournalEntryController1 : ControllerBase
    {
        ...
        private static ConcurrentDictionary<long, JournalEntry1> journalEntries = new ConcurrentDictionary<long, JournalEntry1>();



        // GET /journal
        [HttpGet]
        public ActionResult<IEnumerable<JournalEntry1>> GetAll()
        {
        ...
        // POST /journal
        [HttpPost]
        public ActionResult<bool> CreateEntry([FromBody] JournalEntry1 journalEntry)
        {
        ...
        // GET /journal/id/{myId}
        [HttpGet("id/{myId}")]
        public ActionResult<JournalEntry1> GetJournalEntryById(long myId)
        {
        ...
        [HttpDelete("id/{myId}")]
        public ActionResult<JournalEntry1> DeleteJournalEntry(long myId)
        {
        ...
        // PUT /journal/id/{id}
        [HttpPut("id/{id}")]
        public ActionResult<JournalEntry1> UpdateJournalEntry(long id, [FromBody] JournalEntry1 myEntry)
        {
